...
class DiTBlock(nn.Module):
    ...
    def __init__(self, hidden_size, num_heads, head_dim=None, mlp_ratio=4.0, use_swiglu=False, **block_kwargs):
        ...
        if use_swiglu==False:
            ...
            self.mlp = Mlp(hidden_size=hidden_size, intermediate_size=mlp_hidden_dim, )
...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.blocks = nn.ModuleList([
            DiTBlock(hidden_size, num_heads, head_dim=head_dim, mlp_ratio=mlp_ratio, qk_norm=qk_norm, use_swiglu=use_swiglu) for _ in range(depth)
        ])
